...
- [ ] Offline viewing: captured-on-device photos always viewable (bytes kept as local cache); others need a prior online view. Local byte cache is LRU-evictable (eager prefetch deferred).
